...
public class CustomAdapter extends BaseAdapter {
    /**
     * A ArrayList for the buttons, as required
     */
    private final ArrayList<Button> mButtons;
    /**
     * The width of a column and the height of a column.
     */
    private final int mColumnWidth;
    private final int mColumnHeight;

    /**
     * @param buttons      ArrayList of buttons, that is the slide-able tiles
